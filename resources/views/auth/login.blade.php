                        ...
                        <div
                            ...
                            <div class="et_pb_row">
                                ...
                                <div
                                    ...
                                    <a style="float: right;font-size: larger"  href="{{url('register')}}">For Signup</a>
                                    <h1>Login Here</h1>
                                    <div id=""
                                    ...
                                    >
                                        ...
                                        <div class="et_pb_contact">
                                            <form class=" clearfix"
                                                ...
                                                >
                                                    <label for="email" class="et_pb_contact_form_label">Email
                                                        Address</label>
                                                ...
                                                <p class="et_pb_contact_field et_pb_contact_field_1 et_pb_contact_field_last"
                                                 >
                                                    <label for="password"
                                                           class="et_pb_contact_form_label">Password</label>
