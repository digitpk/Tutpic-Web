        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-sm-6">
                    <img src="img/pics/img-04.jpg" alt="MAXIM - Restaurant & Catering HTML Template" />
                </div><!-- .col-md-6 end -->
                <!-- .col-md-6 start -->
                <div class="col-md-6 col-sm-6 centered">
                    ...
                    <p>Welcome. This is MAXIM. Elegant & sofisticated restaurant template. MAXIM offers different home page layouts with smart and unique design, showcasing beautifully designed elements every restaurant website should have. Smooth animations, fast loading and engaging user
                        experience are just some of the features this template offers.
                        So, give it a try and dive into a world of MAXIM restaurant websites.</p>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-sm-6  centered">
                    ...
                    <p>Here at MAXIM we work with only the best food supliers like small family farms, insuring that we always have the best and always fresh
                        ingredients. You’ll find a large variety of dishes made to satisfy any taste, from sea food, steaks, variety of natural soups, pasta, salads, finest deserts and vines...</p>
                </div><!-- .col-md-6 end -->
                <!-- .col-md-6 start -->
                <div class="col-md-6 col-sm-6">
                    <img src="img/pics/img-05.jpg" alt="MAXIM - Restaurant & Catering HTML Template" />
                </div><!-- .col-md-6 end -->
            </div><!-- .row end -->
        </div><!-- .container end -->
    </div><!-- .page-content end -->
                    ...
                    <div class="custom-heading style-1 triggerAnimation animated" data-animate='fadeInUp'>
                        ...
                        <div class="divider style-2 center">
                            ...
                            <span class="divider-svg">
                                    <img src="img/svg/heading-icon.svg" alt="MAXIM Restaurant & Catering HTML Template">
                                </span>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-sm-6  centered">
                    ...
                    <p>Enjoyable and comfortable atmosphere in the heart of London. MAXIM offers 50 seating places,
                        surrounding a big fireplace that will make your dining exquisite and enjoyable. Carefully selected music and smart
                        interior design will make you feel like home. MAXIM home indoor includes a vine cellar. You can
                        taste any vine from our offering in our vine tasting bar. MAXIM can host large groups too,
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-sm-6 centered">
                    ...
                    <p>Enjoy your dining at MAXIM terrace, surrounded by natural wooden fence and plenty of green.
                        MAXIM terrace offers 72 seating places which can be rearranged for large groups and special
                        events like weddings, corporate parties or baby showers. MAXIM view of the Palma bay in the sunset
                        will take your breath away and make your stay truly MAXIM. You can also visit our terrace bar where
                        our professional staff will offer you our best vines or cocktails, according to your wishes.</p>
                    <a href="#" class="more-details triggerAnimation animated" data-animate='fadeInUp'>Find a table <i class="fa fa-angle-double-right"></i></a>
                </div><!-- .col-md-6 end -->
                <!-- .col-md-6 start -->
                <div class="col-md-6 col-sm-6">
                    <img src="img/pics/img-06.jpg" alt="MAXIM - Restaurant & Catering HTML Template" />
                </div><!-- .col-md-6 end -->
            </div><!-- .row end -->
        </div><!-- .container end -->
    </div><!-- .page-content end -->
            ...
            <div class="row">
                <div class="col-md-4 col-sm-4">
                    <div class="team-member">
                        <figure>
                            <img src="img/pics/team-1.jpg" alt="MAXIM - Restaurant & Catering HTML Template"/>
                ...
                <div class="col-md-4 col-sm-4">
                    <div class="team-member">
                        <figure>
                            <img src="img/pics/team-2.jpg" alt="MAXIM - Restaurant & Catering HTML Template"/>
                            ...
                            <figcaption>
                                ...
                                <p class="member-about">Ashley Cooper is head waiter in MAXIM and an experienced vine taster.
                ...
                <div class="col-md-4 col-sm-4">
                    <div class="team-member">
                        <figure>
                            <img src="img/pics/team-3.jpg" alt="MAXIM - Restaurant & Catering HTML Template"/>
                            ...
                            <figcaption>
                                ...
                                <p class="member-about">Philip Salazar is our expert for deserts. Philip has 12 years of experience
                    ...
                    <div class="fancy-testimonial-background">
                        ...
                        <div class="carousel-container">
                            <div id="fancy-testimonial-carousel" class="owl-carousel owl-theme">
                                <div class="item">
                                    <p>Really enjoyed our stay at MAXIM. Delicious food, friendly staff and exquisite atmosphere. Recommend it!</p>
                                    <p class="testimonial-author">- Nicole Oliver</p>
                                </div>
                                <div class="item">
                                    <p>Best customer support and response time I have ever seen... not to mention a kick ass theme! Great feeling from this pourchase.
                                        Thank you Pixel Industry!</p>
        ...
        <div class="container">
                ...
                <div class="col-md-12 centered mb-0">
                    <div class="custom-heading style-1">
                        ...
                        <div class="divider style-2 center">
                            <span class="hr-double left"></span>
                            <span class="divider-svg">
                                    <img class="svg-brown" src="img/svg/heading-icon.svg" alt="MAXIM Restaurant & Catering HTML Template">
                                </span>
                            <span class="hr-double right"></span>
                        </div>
                    </div><!-- .custom-heading.style-1 end -->
            ...
            <div class="row">
                ...
                <div class="col-md-4 col-sm-4 ">
                    ...
                    <ul>
                        <li>MAXIM Indoors,</li>
                        <li>22nd Sunrise street, MAXIM Club Avenue,</li>
                        <li>London, UK</li>
                    </ul>
                    <h5>OPENING HOURS:</h5>
                    <ul>
                    ...
                    <ul>
                        ...
                        <li>info@MAXIM-plate.com</li>
                    </ul>
                    <a href="#" class="more-details triggerAnimation animated" data-animate='fadeInUp'>Get directions <i class="fa fa-angle-double-right"></i></a>
