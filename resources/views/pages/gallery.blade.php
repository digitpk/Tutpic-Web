            ...
            <div class="row">
                <ul id="galleryitems" class="isotope isotopeitems-full">
                    <li class="col-xs-6 col-md-3 isotope-item outdoor">
                        <figure class="gallery-item-container">
                            <div class="gallery-img">
                                <img src="img/pics/img-18.jpg" alt="MAXIM - Restaurant & Catering "/>

                                <div class="hover-mask-container">
                                    <div class="hover-zoom">
                                        <a href="img/pics/img-18.jpg" class="triggerZoom fa fa-search"></a>
                                    </div><!-- .hover-zoom end -->
                    ...
                    <li class="col-xs-6 col-md-3 isotope-item outdoor">
                        <figure class="gallery-item-container">
                            <div class="gallery-img">
                                <img src="img/pics/img-19.jpg" alt="MAXIM - Restaurant & Catering "/>

                                <div class="hover-mask-container">
                                    <div class="hover-zoom">
                                        <a href="img/pics/img-19.jpg" class="triggerZoom fa fa-search"></a>
                                    </div><!-- .hover-zoom end -->
                                </div><!-- .hover-mask-container end -->
                            </div><!-- .gallery-img end -->
                        </figure><!-- .gallery-item-container end -->
                    ...
                    <li class="col-xs-6 col-md-3 isotope-item indoor">
                        <figure class="gallery-item-container">
                            <div class="gallery-img">
                                <img src="img/pics/img-20.jpg" alt="MAXIM - Restaurant & Catering "/>

                                <div class="hover-mask-container">
                                    <div class="hover-zoom">
                                        <a href="img/pics/img-20.jpg" class="triggerZoom fa fa-search"></a>
                                    </div><!-- .hover-zoom end -->
                                </div><!-- .hover-mask-container end -->
                            </div><!-- .gallery-img end -->
                        </figure><!-- .gallery-item-container end -->
                    ...
                    <li class="col-xs-6 col-md-3 isotope-item indoor">
                        <figure class="gallery-item-container">
                            <div class="gallery-img">
                                <img src="img/pics/img-21.jpg" alt="MAXIM - Restaurant & Catering "/>

                                <div class="hover-mask-container">
                                    <div class="hover-zoom">
                                        <a href="img/pics/img-21.jpg" class="triggerZoom fa fa-search"></a>
                                    </div><!-- .hover-zoom end -->
                                </div><!-- .hover-mask-container end -->
                            </div><!-- .gallery-img end -->
                        </figure><!-- .gallery-item-container end -->
                    ...
                    <li class="col-xs-6 col-md-3 isotope-item indoor">
                        <figure class="gallery-item-container">
                            <div class="gallery-img">
                                <img src="img/pics/img-22.jpg" alt="MAXIM - Restaurant & Catering "/>

                                <div class="hover-mask-container">
                                    <div class="hover-zoom">
                                        <a href="img/pics/img-22.jpg" class="triggerZoom fa fa-search"></a>
                                    </div><!-- .hover-zoom end -->
                                </div><!-- .hover-mask-container end -->
                            </div><!-- .gallery-img end -->
                        </figure><!-- .gallery-item-container end -->
                    ...
                    <li class="col-xs-6 col-md-3 isotope-item indoor">
                        <figure class="gallery-item-container">
                            <div class="gallery-img">
                                <img src="img/pics/img-23.jpg" alt="MAXIM - Restaurant & Catering "/>

                                <div class="hover-mask-container">
                                    <div class="hover-zoom">
                                        <a href="img/pics/img-23.jpg" class="triggerZoom fa fa-search"></a>
                                    </div><!-- .hover-zoom end -->
                                </div><!-- .hover-mask-container end -->
                            </div><!-- .gallery-img end -->
                        </figure><!-- .gallery-item-container end -->
                    ...
                    <li class="col-xs-6 col-md-3 isotope-item outdoor">
                        <figure class="gallery-item-container">
                            <div class="gallery-img">
                                <img src="img/pics/img-24.jpg" alt="MAXIM - Restaurant & Catering "/>

                                <div class="hover-mask-container">
                                    <div class="hover-zoom">
                                        <a href="img/pics/img-24.jpg" class="triggerZoom fa fa-search"></a>
                                    </div><!-- .hover-zoom end -->
                                </div><!-- .hover-mask-container end -->
                            </div><!-- .gallery-img end -->
                        </figure><!-- .gallery-item-container end -->
                    ...
                    <li class="col-xs-6 col-md-3 isotope-item outdoor">
                        <figure class="gallery-item-container">
                            <div class="gallery-img">
                                <img src="img/pics/img-25.jpg" alt="MAXIM - Restaurant & Catering "/>

                                <div class="hover-mask-container">
                                    <div class="hover-zoom">
                                        <a href="img/pics/img-25.jpg" class="triggerZoom fa fa-search"></a>
                                    </div><!-- .hover-zoom end -->
                                </div><!-- .hover-mask-container end -->
                            </div><!-- .gallery-img end -->
                        </figure><!-- .gallery-item-container end -->
                    ...
                    <li class="col-xs-6 col-md-3 isotope-item indoor">
                        <figure class="gallery-item-container">
                            <div class="gallery-img">
                                <img src="img/pics/img-26.jpg" alt="MAXIM - Restaurant & Catering "/>

                                <div class="hover-mask-container">
                                    <div class="hover-zoom">
                                        <a href="img/pics/img-26.jpg" class="triggerZoom fa fa-search"></a>
                                    </div><!-- .hover-zoom end -->
                                </div><!-- .hover-mask-container end -->
                            </div><!-- .gallery-img end -->
                        </figure><!-- .gallery-item-container end -->
                    ...
                    <li class="col-xs-6 col-md-3 isotope-item indoor">
                        <figure class="gallery-item-container">
                            <div class="gallery-img">
                                <img src="img/pics/img-27.jpg" alt="MAXIM - Restaurant & Catering "/>

                                <div class="hover-mask-container">
                                    <div class="hover-zoom">
                                        <a href="img/pics/img-27.jpg" class="triggerZoom fa fa-search"></a>
                                    </div><!-- .hover-zoom end -->
                                </div><!-- .hover-mask-container end -->
                            </div><!-- .gallery-img end -->
                        </figure><!-- .gallery-item-container end -->
                    ...
                    <li class="col-xs-6 col-md-3 isotope-item indoor">
                        <figure class="gallery-item-container">
                            <div class="gallery-img">
                                <img src="img/pics/img-28.jpg" alt="MAXIM - Restaurant & Catering "/>

                                <div class="hover-mask-container">
                                    <div class="hover-zoom">
                                        <a href="img/pics/img-28.jpg" class="triggerZoom fa fa-search"></a>
                                    </div><!-- .hover-zoom end -->
                                </div><!-- .hover-mask-container end -->
                            </div><!-- .gallery-img end -->
                        </figure><!-- .gallery-item-container end -->
                    ...
                    <li class="col-xs-6 col-md-3 isotope-item outdoor">
                        <figure class="gallery-item-container">
                            <div class="gallery-img">
                                <img src="img/pics/img-29.jpg" alt="MAXIM - Restaurant & Catering "/>

                                <div class="hover-mask-container">
                                    <div class="hover-zoom">
                                        <a href="img/pics/img-29.jpg" class="triggerZoom fa fa-search"></a>
                                    </div><!-- .hover-zoom end -->
                                </div><!-- .hover-mask-container end -->
                            </div><!-- .gallery-img end -->
                        </figure><!-- .gallery-item-container end -->
