    ...
    <div class="container">
        ...
        <div class="row rn-slick-activation rn-slick-dot pb--25" data-slick-options='{
            ...
            <div class="blog blog-style--1">
                <div class="thumbnail">
                    <a href="blog-details.html">
                        <img class="w-100" src="<?php echo e(asset('/')); ?>assets/images/blog/blog-01.jpg" alt="Blog Images" />
                    </a>
                </div>
                <div class="content">
            ...
            <div class="blog blog-style--1">
                <div class="thumbnail">
                    <a href="blog-details.html">
                        <img class="w-100" src="<?php echo e(asset('/')); ?>assets/images/blog/blog-02.jpg" alt="Blog Images" />
                    </a>
                </div>
                <div class="content">
                    <p class="blogtype">Development</p>
            ...
            <div class="blog blog-style--1">
                <div class="thumbnail">
                    <a href="blog-details.html">
                        <img class="w-100" src="<?php echo e(asset('/')); ?>assets/images/blog/blog-03.jpg" alt="Blog Images" />
                    </a>
                </div>
                <div class="content">
                    <p class="blogtype">Development</p>
            ...
            <div class="blog blog-style--1">
                <div class="thumbnail">
                    <a href="blog-details.html">
                        <img class="w-100" src="<?php echo e(asset('/')); ?>assets/images/blog/blog-04.jpg" alt="Blog Images" />
                    </a>
                </div>
                <div class="content">
                    <p class="blogtype">Development</p>
...
<!-- End Blog Area  -->
<?php /**PATH C:\Users\Abdul Majid\Downloads\Personal\DIGIT\Repositories\Tutpic-Web\resources\views/pages/blog.blade.php ENDPATH**/ ?>